...
#
# 1    0.000    0.000    0.000    0.000 tmp.py:7(version_1) -               1 000
# 1    0.001    0.001    0.001    0.001 tmp.py:7(version_1) -               10 000
#
# 1    0.004    0.004    0.004    0.004 tmp.py:13(<listcomp>)
# 1    0.006    0.006    0.010    0.010 tmp.py:7(version_1) -               100 000
# 1    0.000    0.000    0.011    0.011 {built-in method builtins.exec}
#
# 1    0.055    0.055    0.055    0.055 tmp.py:13(<listcomp>)
# 1    0.055    0.055    0.110    0.110 tmp.py:7(version_1) -               1 000 000
# 1    0.000    0.000    0.112    0.112 {built-in method builtins.exec}
#
# 1    0.113    0.113    0.113    0.113 tmp.py:13(<listcomp>)
# 1    0.112    0.112    0.226    0.226 tmp.py:7(version_1) -               2 000 000
...
# 1    0.000    0.000    1.146    1.146 {built-in method builtins.exec}
#
...
# 1    0.000    0.000    0.000    0.000 tmp.py:67(version_2) - 100000000000000000000000000000000000
...
# 1    0.050    0.050    0.052    0.052 tmp.py:109(version_3) -                 1 000
# 1    0.000    0.000    0.052    0.052 {built-in method builtins.exec}
#
# 2000    0.001    0.000    0.004    0.000 random.py:218(randint)
# 1    0.199    0.199    0.203    0.203 tmp.py:109(version_3) -                 2 000
# 1    0.000    0.000    0.203    0.203 {built-in method builtins.exec}
#
# 3000    0.001    0.000    0.006    0.000 random.py:218(randint)
# 1    0.443    0.443    0.450    0.450 tmp.py:109(version_3) -                 3 000
# 1    0.000    0.000    0.450    0.450 {built-in method builtins.exec}
#
# 5000    0.002    0.000    0.010    0.000 random.py:218(randint)
# 1    1.247    1.247    1.258    1.258 tmp.py:109(version_3) -                 5 000
# 1    0.000    0.000    1.258    1.258 {built-in method builtins.exec}
#
# 6000    0.002    0.000    0.012    0.000 random.py:218(randint)
# 1    1.799    1.799    1.813    1.813 tmp.py:109(version_3) -                 6 000
# 1    0.000    0.000    1.813    1.813 {built-in method builtins.exec}
#
# 10000    0.003    0.000    0.019    0.000 random.py:218(randint)
# 1    4.978    4.978    5.001    5.001 tmp.py:109(version_3) -                 10 000
...
# 1    0.002    0.002    0.024    0.024 tmp.py:176(version_4) -             10 000
# 1    0.003    0.003    0.022    0.022 tmp.py:179(<listcomp>)
# 1    0.000    0.000    0.024    0.024 {built-in method builtins.exec}
#
# 1    0.021    0.021    0.244    0.244 tmp.py:176(version_4)
# 1    0.027    0.027    0.222    0.222 tmp.py:179(<listcomp>) -            100 000
# 1    0.000    0.000    0.244    0.244 {built-in method builtins.exec}
#
# 1    0.044    0.044    0.498    0.498 tmp.py:176(version_4)
# 1    0.058    0.058    0.454    0.454 tmp.py:179(<listcomp>) -            200 000
# 1    0.000    0.000    0.499    0.499 {built-in method builtins.exec}
#
# 1    0.220    0.220    2.484    2.484 tmp.py:176(version_4)
# 1    0.294    0.294    2.265    2.265 tmp.py:179(<listcomp>) -            1 000 000
# 1    0.000    0.000    2.489    2.489 {built-in method builtins.exec}
#
# 1    0.441    0.441    5.000    5.000 tmp.py:176(version_4) -             2 000 000
# 1    0.597    0.597    4.559    4.559 tmp.py:179(<listcomp>)
# 1    0.000    0.000    5.009    5.009 {built-in method builtins.exec}
